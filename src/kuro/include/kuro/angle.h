// Generated by gencpp from file kuro/angle.msg
// DO NOT EDIT!


#ifndef KURO_MESSAGE_ANGLE_H
#define KURO_MESSAGE_ANGLE_H
...
struct angle_
{
  ...
  typedef boost::shared_ptr< ::kuro::angle_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::kuro::angle_<ContainerAllocator> const> ConstPtr;

}; // struct angle_

typedef ::kuro::angle_<std::allocator<void> > angle;

typedef boost::shared_ptr< ::kuro::angle > anglePtr;
typedef boost::shared_ptr< ::kuro::angle const> angleConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::kuro::angle_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::kuro::angle_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::kuro::angle_<ContainerAllocator1> & lhs, const ::kuro::angle_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::kuro::angle_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::kuro::angle_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::kuro::angle_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::kuro::angle_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::kuro::angle_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::kuro::angle_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::kuro::angle_<ContainerAllocator> >
{
  ...
  static const char* value(const ::kuro::angle_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x8a9844d15e7c2d70ULL;
  static const uint64_t static_value2 = 0x6de09370705e24dcULL;
};

template<class ContainerAllocator>
struct DataType< ::kuro::angle_<ContainerAllocator> >
{
  static const char* value()
  {
    return "kuro/angle";
...
template<class ContainerAllocator>
struct Definition< ::kuro::angle_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::kuro::angle_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::kuro::angle_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::kuro::angle_<ContainerAllocator>& v)
  {
    s << indent << "r_ang_1: ";
